...
## 👥 制作团队与贡献者 (Credits & Team)

本项目为黑河学院「焦外述影」摄影与影像创作社团官方独立作品，由团队协力共创完成：

- **💻 架构设计、交互创意与独立全栈开发 (Creator & Lead Full-Stack Engineer)**：
  - **哆啦（倪聪）** ([@AdgaiWalker](https://github.com/AdgaiWalker))  
    承担项目从 0 到 1 的完整前端架构、全部代码工程实现、XPBD 暗房物理动力学算法设计、3D 空间螺旋展廊研发、Token 与工作流调度、视觉打磨、端到端测试与最终生产环境部署上线。
- **📷 视觉作品与影像素材 (Lead Photographer & Visual Assets)**：
  - **喵喵酱**：提供界江晨光、校园全景长卷、林荫大道、星轨与暗房研习等核心高清样片。
  - **周泓旭（第一任社长）**：提供社团初创期纪实影像、暗房冲印档案及官方获奖荣誉证书资料。
- **🌐 基础设施与平台赞助 (Infrastructure & Sponsorship)**：
  - **周泓旭（第一任社长）**：赞助购买了社团官方独立域名，并提供了线上部署账号与平台支持。
- **🤝 招新统筹与社群联络 (Community Operations & Liaison)**：
  - **吴长轩**：负责社团对外招新事务联络、新生咨询答疑与入社群聊运营对接。

*(特别致谢：所有在零下三十度严寒与秋日落叶街头并肩掌镜创作的历届社团成员。)*
