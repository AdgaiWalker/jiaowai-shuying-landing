...
export const faqs = [
  { q: "关于专业基础", a: "社团绝大多数成员在入学前从未接触过专业摄影。前辈会从第一颗按键与构图规律开始，带你稳步上手。" },
  { q: "关于拍摄器材", a: "社团公共微单、镜头与稳定器面向全体成员开放借用，手机创作同样被认真对待。" },
  { q: "关于社团费用", a: "社团不收取任何形式的会费或入社杂费，日常技能分享与所有基础活动完全免费。" },
  { q: "关于课业时间", a: "所有外拍与研习均安排在周末或无课时段，期末考试阶段全面停休，不挤占学业精力。" },
  { q: "关于作品展示", a: "你的优秀成片将由社团推荐至学校官方新媒体与《黑河日报》发表，并参与校园影展展出。" },
  { q: "关于加入方式", a: "保存或长按下方二维码进入迎新群即可，招新通道长期开启，随时为你保留席位。" },
];
