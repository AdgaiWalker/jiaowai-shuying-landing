...
export function MobileCtaBar() {
  ...
  return (
    <div
      ref={barRef}
      className="fixed inset-x-0 bottom-0 z-40 apple-glass apple-hairline-t transition-[transform,opacity] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none md:hidden translate-y-full opacity-0 pointer-events-none"
    >
